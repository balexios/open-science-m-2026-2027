...
% Set the type of application (M-2), changes the header
\lhead{Application Form M-2 - NWO Open Competition Domain Science, 2026-2027}
...
% When applying for ‘Scientific personnel at a research organisation abroad’ the foreign researcher should be the co-applicant and funding is requested for a scientific position (PhD or Postdoc) abroad; please see the Call for Proposals for more information and requirements, or contact NWO.


\subsection{Embedding of research and relevant expertise of researchers involved}
% Describe how the proposed research fits with the participating researcher(s) and indicate how the proposed research fits within the (inter)national science landscape. If applicable, you may wish to use the suggested headings.
...
% This is new table environment with only two columns, whose width can be specified
\textbf{Co-applicant - additional information}
\begin{texttable}{8cm}{9cm}
  Name (titles, initials, first name, last name): & \\ % Prof. dr. J. (Joan) Doe
  Affiliation - university/institute: & \\ % University of Discworld
  Affiliation - department: & \\ %Department of Magic
