...
% Set the type of application (M-1-Weave), changes the header
\lhead{Application Form M-1-Weave - NWO Open Competition Domain Science, 2026-2027}
...
% * Section A.2 is limited to eight pages, (including figures and tables, but excluding the list of literature references);
...
% * Budget table for funding requested at partner agency
...
\subsection{Approach}
% Describe which methods and techniques will be used in the proposed research and discuss their applicability and accessibility. Discuss the need and added value of the collaboration between the main applicant and co-applicant. Include a detailed work plan and indicate the duration of the proposed research.


\subsection{Justification}
% Provide a justification for the budget requested at NWO as well as DFG/FNR/FWO.
...
% * Applying for budget under the module ‘Scientific personnel at a research organisation abroad’ is not possible in an M-1-WEAVE application.



\subsection{Embedding of research and relevant expertise of researchers involved}
% Describe how the proposed research fits with the participating researchers and indicate how the proposed research fits within the (inter)national science landscape. Note that referees and the committee do not assess the CV of the applicants but only the extent to which the appropriate expertise of the researchers is involved as well as appropriate embedding of the research and access to the equipment needed. If applicable, you may wish to use the suggested headings. 

Expertise
% Describe the expertise of the applicants, but refrain from including an extensive CV. Hence, you are instructed to only list relevant information regarding expertise without describing a full track record. Also explain in which way the collaboration between the applicants has clear added value. 
...
\part{Applicants and additional information}
...
% This is new table environment with only two columns, whose width can be specified. (copy this table as often as needed for more co-applicants)
\textbf{Co-applicant(s) - additional information}
\begin{texttable}{8cm}{9cm}
  Name (titles, initials, first name, last name): & \\ % Prof. dr. J. (Joan) Doe
  Affiliation - university/institute: & \\ % University of Discworld
  Affiliation - department: & \\ %Department of Magic
  ...
  Paid position: & \\ % Choose: yes / no
  Type of contract: & \\ % Choose: tenure track / permanent / probationary one or two year contract
  End date of contract: & \\ % Fill out: N/A or dd-mm-yyyy
\end{texttable}
